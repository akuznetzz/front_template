import {AnyFunction, ColorDef, MaybePromise, MaybePromiseOrUndef, RectProps} from "./base";
import {
  AnyListener,
...
import {ColorPropertyDefine, ColorsPropertyDefine, FontPropertyDefine, LineClamp, TextOverflow} from "./define";
