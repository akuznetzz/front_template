...
declare module 'cheetah-grid' {
  import * as TYPES from "cheetah-grid/ts-types";
...
declare module 'cheetah-grid/register' {
  import {IconDefine} from "cheetah-grid/ts-types";
...
declare module 'cheetah-grid/themes' {
  import {Theme} from "cheetah-grid/themes/theme";
  import {ThemeDefine} from "cheetah-grid/ts-types";
...
declare module 'cheetah-grid/ListGrid' {
  ...
  import {
    ...
    LayoutDefine,
    LayoutMapAPI
  } from "cheetah-grid/list-grid/layout-map";
  import {DrawGrid, DrawGridConstructorOptions, DrawGridProtected} from "cheetah-grid/core/DrawGrid";
  import {GridCanvasHelper} from "cheetah-grid/GridCanvasHelper";
  ...
  const _: "$$$$protected symbol$$$$";
    ...
    export class ListGrid<T> extends DrawGrid implements ListGridAPI<T> {
            ...
            sortStateToSortStateFieldMap(sortState: SortState): Map<any, SortColumnState>;
            /**
                * Sets the sort state.
...
declare module 'cheetah-grid/GridCanvasHelper' {
  ...
  import {SimpleColumnIconOption} from "cheetah-grid/ts-types-internal";
...
declare module 'cheetah-grid/ts-types/grid' {
  import {MaybePromiseOrUndef} from "cheetah-grid/ts-types/base";
...
declare module 'cheetah-grid/ts-types/events' {
  import {CellAddress, CellRange, FieldDef} from "cheetah-grid/ts-types/grid";
  import {AnyFunction} from "cheetah-grid/ts-types/base";
...
declare module 'cheetah-grid/ts-types/plugin' {
  import {ColorPropertyDefine, ColorsPropertyDefine} from "cheetah-grid/ts-types/define";
...
declare module 'cheetah-grid/ts-types/define' {
  import {ColorDef} from "cheetah-grid/ts-types/base";
  ...
  export interface FontIcon<T> {
    ...
    export type ColumnMenuItemOptions = ColumnMenuItemOption[] | SimpleColumnMenuItemOption[] | string | ColumnMenuItemObjectOptions;
...
declare module 'cheetah-grid/ts-types/grid-engine' {
  import {AnyFunction, ColorDef, MaybePromise, MaybePromiseOrUndef, RectProps} from "cheetah-grid/ts-types/base";
  import {
    AnyListener,
  ...
  import {CellAddress, CellRange, FieldData, FieldDef} from "cheetah-grid/ts-types/grid";
  import {
    ColorPropertyDefine,
    ColorsPropertyDefine,
    FontPropertyDefine,
    LineClamp,
    TextOverflow
  } from "cheetah-grid/ts-types/define";
  import {RequiredThemeDefine} from "cheetah-grid/ts-types/plugin";
  import {SimpleColumnIconOption} from "cheetah-grid/ts-types-internal/data";
...
declare module 'cheetah-grid/columns/action' {
  ...
  class ImmutableCheckEditor extends CheckEditor<any> {
    ...
    /**
      ...
      */
    export { BaseAction, Editor, Action, CheckEditor, ButtonAction, SmallDialogInputEditor, InlineInputEditor, InlineMenuEditor, ActionOption, BaseActionOption, ButtonActionOption, EditorOption, InlineInputEditorOption, InlineMenuEditorOption, SmallDialogInputEditorOption };
...
declare module 'cheetah-grid/columns/style' {
  ...
  const EVENT_TYPE: {
    ...
    export { EVENT_TYPE, BaseStyle, Style, NumberStyle, CheckStyle, ButtonStyle, ImageStyle, IconStyle, PercentCompleteBarStyle, MultilineTextStyle, MenuStyle, BaseStyleOption, ButtonStyleOption, CheckStyleOption, IconStyleOption, ImageStyleOption, MenuStyleOption, MultilineTextStyleOption, NumberStyleOption, PercentCompleteBarStyleOption, StyleOption };
...
declare module 'cheetah-grid/columns/type' {
  ...
  /**
      ...
      * @memberof cheetahGrid.columns
      */
    export { Column, NumberColumn, CheckColumn, ButtonColumn, ImageColumn, PercentCompleteBarColumn, IconColumn, BranchGraphColumn, MenuColumn, MultilineTextColumn, BaseColumnOption, BranchGraphColumnOption, ButtonColumnOption, IconColumnOption, MenuColumnOption, NumberColumnOption, PercentCompleteBarColumnOption };
...
declare module 'cheetah-grid/data/DataSource' {
  import {DataSourceAPI, FieldData, FieldDef, MaybePromise, MaybePromiseOrUndef} from "cheetah-grid/ts-types";
  import {EventTarget} from "cheetah-grid/core/EventTarget";
  import {PromiseCacheValue} from "cheetah-grid/data/internal/types";
  const EVENT_TYPE: {
...
declare module 'cheetah-grid/data/CachedDataSource' {
  import {DataSource, DataSourceParam} from "cheetah-grid/data/DataSource";
  import {FieldData, FieldDef, MaybePromise, MaybePromiseOrUndef} from "cheetah-grid/ts-types";
  import {PromiseCacheValue} from "cheetah-grid/data/internal/types";
...
declare module 'cheetah-grid/data/FilterDataSource' {
  import {FieldDef, MaybePromise, MaybePromiseOrUndef} from "cheetah-grid/ts-types";
...
declare module 'cheetah-grid/header/action' {
  import {BaseActionOption, HeaderActionOption, SortHeaderActionOption} from "cheetah-grid/ts-types";
  import {BaseAction} from "cheetah-grid/header/action/BaseAction";
  import {BaseHeaderDefine} from "cheetah-grid/list-grid/layout-map/api";
...
declare module 'cheetah-grid/header/type' {
  ...
  import {HeaderTypeOption} from "cheetah-grid/ts-types";
...
declare module 'cheetah-grid/tools/canvashelper' {
  import {PaddingOption} from "cheetah-grid/internal/canvases";
  import {ColorDef} from "cheetah-grid/ts-types";
...
declare module 'cheetah-grid/list-grid/LG_EVENT_TYPE' {
  import {DrawGridEvents} from "cheetah-grid/core/DG_EVENT_TYPE";
...
declare module 'cheetah-grid/columns/message/MessageHandler' {
  import {DrawCellInfo, MessageHandler as Base} from "cheetah-grid/ts-types-internal";
  import {CellContext, ColumnStyle, GridCanvasHelperAPI, ListGridAPI, Message} from "cheetah-grid/ts-types";
  import {BaseMessage} from "cheetah-grid/columns/message/BaseMessage";
...
declare module 'cheetah-grid/tooltip/TooltipHandler' {
  import {ListGridAPI} from "cheetah-grid/ts-types";
...
declare module 'cheetah-grid/element/InlineDrawer' {
  import {AnyFunction, ColorDef} from "cheetah-grid/ts-types";
  import {Inline, InlineDrawOption} from "cheetah-grid/element/Inline";
  export type InlineDrawerFunction = (options: InlineDrawOption) => void;
    export class InlineDrawer extends Inline {
        constructor({ draw, width, height, color }: {
...
declare module 'cheetah-grid/ts-types/column/type' {
  import {ColumnMenuItemOptions} from "cheetah-grid/ts-types/define";
...
declare module 'cheetah-grid/ts-types/column/style' {
  import {LineClamp, TextOverflow} from "cheetah-grid/ts-types/define";
  import {ColorDef} from "cheetah-grid/ts-types/base";
...
declare module 'cheetah-grid/ts-types/column/action' {
  import {ColumnMenuItemOptions} from "cheetah-grid/ts-types/define";
  import {ListGridAPI} from "cheetah-grid/ts-types/grid-engine";
  import {MaybePromise} from "cheetah-grid/ts-types/base";
...
declare module 'cheetah-grid/ts-types-internal/data' {
  import {ColorDef, MaybePromise} from "cheetah-grid/ts-types/base";
...
declare module 'cheetah-grid/columns/action/Action' {
  ...
  import {BaseAction} from "cheetah-grid/columns/action/BaseAction";
  import {GridInternal} from "cheetah-grid/ts-types-internal";
...
declare module 'cheetah-grid/columns/action/BaseAction' {
  import {BaseActionOption, CellAddress, EventListenerId, LayoutObjectId, ListGridAPI} from "cheetah-grid/ts-types";
...
declare module 'cheetah-grid/columns/action/ButtonAction' {
  import {ButtonColumnState, GridInternal} from "cheetah-grid/ts-types-internal";
  import {Action} from "cheetah-grid/columns/action/Action";
...
declare module 'cheetah-grid/columns/action/CheckEditor' {
  import {CellAddress, EventListenerId, LayoutObjectId} from "cheetah-grid/ts-types";
  import {Editor} from "cheetah-grid/columns/action/Editor";
  import {GridInternal} from "cheetah-grid/ts-types-internal";
...
declare module 'cheetah-grid/columns/action/Editor' {
  import {BaseAction} from "cheetah-grid/columns/action/BaseAction";
  import {EditorOption} from "cheetah-grid/ts-types";
...
declare module 'cheetah-grid/columns/action/InlineInputEditor' {
  import {CellAddress, InlineInputEditorOption, ListGridAPI} from "cheetah-grid/ts-types";
...
declare module 'cheetah-grid/columns/action/InlineMenuEditor' {
  ...
  export class InlineMenuEditor<T> extends Editor<T> {
        ...
        set options(options: ColumnMenuItemOption[]);
...
declare module 'cheetah-grid/columns/action/SmallDialogInputEditor' {
  import {CellAddress, ListGridAPI, MaybePromise, SmallDialogInputEditorOption} from "cheetah-grid/ts-types";
  import {BaseInputEditor} from "cheetah-grid/columns/action/BaseInputEditor";
  type GetValueResult<T, R> = (value: string, info: {
        grid: ListGridAPI<T>;
        col: number;
...
declare module 'cheetah-grid/columns/style/BaseStyle' {
  import {BaseStyleOption, ColorDef, ColumnStyle} from "cheetah-grid/ts-types";
  import {EventTarget} from "cheetah-grid/core/EventTarget";
...
declare module 'cheetah-grid/columns/style/ButtonStyle' {
  import {ButtonStyleOption, ColorDef} from "cheetah-grid/ts-types";
  import {Style} from "cheetah-grid/columns/style/Style";
...
declare module 'cheetah-grid/columns/style/CheckStyle' {
  import {CheckStyleOption, ColorDef} from "cheetah-grid/ts-types";
...
declare module 'cheetah-grid/columns/style/IconStyle' {
  import {IconStyleOption} from "cheetah-grid/ts-types";
  import {Style} from "cheetah-grid/columns/style/Style";
...
declare module 'cheetah-grid/columns/style/ImageStyle' {
  import {ImageStyleOption} from "cheetah-grid/ts-types";
  import {StdBaseStyle} from "cheetah-grid/columns/style/StdBaseStyle";
...
declare module 'cheetah-grid/columns/style/MenuStyle' {
  import {MenuStyleOption} from "cheetah-grid/ts-types";
  import {Style} from "cheetah-grid/columns/style/Style";
...
declare module 'cheetah-grid/columns/style/MultilineTextStyle' {
  import {LineClamp, MultilineTextStyleOption} from "cheetah-grid/ts-types";
  import {Style} from "cheetah-grid/columns/style/Style";
...
declare module 'cheetah-grid/columns/style/NumberStyle' {
  import {NumberStyleOption} from "cheetah-grid/ts-types";
  import {Style} from "cheetah-grid/columns/style/Style";
...
declare module 'cheetah-grid/columns/style/PercentCompleteBarStyle' {
  import {ColorDef, PercentCompleteBarStyleOption} from "cheetah-grid/ts-types";
  import {Style} from "cheetah-grid/columns/style/Style";
...
declare module 'cheetah-grid/columns/style/Style' {
  import {ColorDef, StyleOption, TextOverflow} from "cheetah-grid/ts-types";
  import {StdBaseStyle} from "cheetah-grid/columns/style/StdBaseStyle";
...
declare module 'cheetah-grid/columns/type/BaseColumn' {
  ...
  import {DrawCellInfo} from "cheetah-grid/ts-types-internal";
  import {BaseStyle} from "cheetah-grid/columns/style/BaseStyle";
...
declare module 'cheetah-grid/columns/type/BranchGraphColumn' {
  import {BranchGraphColumnOption, CellContext, GridCanvasHelperAPI, MaybePromise} from "cheetah-grid/ts-types";
  import {DrawCellInfo, GridInternal} from "cheetah-grid/ts-types-internal";
  import {BaseColumn} from "cheetah-grid/columns/type/BaseColumn";
...
declare module 'cheetah-grid/columns/type/ButtonColumn' {
  import {ButtonColumnOption, CellContext, GridCanvasHelperAPI} from "cheetah-grid/ts-types";
  import {DrawCellInfo, GridInternal} from "cheetah-grid/ts-types-internal";
  import {ButtonStyle} from "cheetah-grid/columns/style/ButtonStyle";
  import {Column} from "cheetah-grid/columns/type/Column";
...
declare module 'cheetah-grid/columns/type/CheckColumn' {
  import {CellContext, GridCanvasHelperAPI} from "cheetah-grid/ts-types";
  import {DrawCellInfo, GridInternal} from "cheetah-grid/ts-types-internal";
  import {BaseColumn} from "cheetah-grid/columns/type/BaseColumn";
  import {CheckStyle} from "cheetah-grid/columns/style/CheckStyle";
...
declare module 'cheetah-grid/columns/type/Column' {
  import {CellContext, GridCanvasHelperAPI, ListGridAPI} from "cheetah-grid/ts-types";
  import {BaseColumn} from "cheetah-grid/columns/type/BaseColumn";
  import {DrawCellInfo} from "cheetah-grid/ts-types-internal";
  import {Style} from "cheetah-grid/columns/style/Style";
...
declare module 'cheetah-grid/columns/type/IconColumn' {
  import {CellContext, GridCanvasHelperAPI, IconColumnOption, ListGridAPI} from "cheetah-grid/ts-types";
  import {Column} from "cheetah-grid/columns/type/Column";
  import {DrawCellInfo} from "cheetah-grid/ts-types-internal";
  import {IconStyle} from "cheetah-grid/columns/style/IconStyle";
...
declare module 'cheetah-grid/columns/type/ImageColumn' {
  import {CellContext, GridCanvasHelperAPI, ListGridAPI, MaybePromise} from "cheetah-grid/ts-types";
  import {BaseColumn} from "cheetah-grid/columns/type/BaseColumn";
  import {DrawCellInfo} from "cheetah-grid/ts-types-internal";
  import {ImageStyle} from "cheetah-grid/columns/style/ImageStyle";
...
declare module 'cheetah-grid/columns/type/NumberColumn' {
  import {Column} from "cheetah-grid/columns/type/Column";
  import {NumberColumnOption} from "cheetah-grid/ts-types";
  import {NumberStyle} from "cheetah-grid/columns/style/NumberStyle";
...
declare module 'cheetah-grid/columns/type/PercentCompleteBarColumn' {
  import {CellContext, GridCanvasHelperAPI, ListGridAPI, PercentCompleteBarColumnOption} from "cheetah-grid/ts-types";
  import {Column} from "cheetah-grid/columns/type/Column";
  import {DrawCellInfo} from "cheetah-grid/ts-types-internal";
  import {PercentCompleteBarStyle} from "cheetah-grid/columns/style/PercentCompleteBarStyle";
...
declare module 'cheetah-grid/internal/EventHandler' {
  import {AnyFunction, EventListenerId} from "cheetah-grid/ts-types";
  import {EventTarget as CustomEventTarget} from "cheetah-grid/core/EventTarget";
...
declare module 'cheetah-grid/core/EventTarget' {
  import {AnyListener, EventListenerId} from "cheetah-grid/ts-types";
  const _: "$$$$private symbol$$$$";
    /**
        * event target.
        */
...
declare module 'cheetah-grid/internal/Rect' {
  import {RectProps} from "cheetah-grid/ts-types";
...
declare module 'cheetah-grid/data/internal/types' {
  import {MaybePromiseOrUndef} from "cheetah-grid/ts-types";
  export type PromiseCacheValue<V> = MaybePromiseOrUndef<V>;
}

declare module 'cheetah-grid/header/action/BaseAction' {
  import {BaseActionOption, EventListenerId, LayoutObjectId, ListGridAPI} from "cheetah-grid/ts-types";
...
declare module 'cheetah-grid/list-grid/layout-map/api' {
  import * as headerAction from "cheetah-grid/header/action";
  import * as headerType from "cheetah-grid/header/type";
  import {
    CellRange,
    ColumnActionOption,
    ColumnIconOption,
  ...
  import {BaseAction} from "cheetah-grid/columns/action";
  import {BaseColumn} from "cheetah-grid/columns/type/BaseColumn";
  import {BaseStyle as HeaderBaseStyle} from "cheetah-grid/header/style";
...
declare module 'cheetah-grid/header/action/CheckHeaderAction' {
  import {EventListenerId, LayoutObjectId} from "cheetah-grid/ts-types";
  import {GridInternal} from "cheetah-grid/ts-types-internal";
  import {BaseAction} from "cheetah-grid/header/action/BaseAction";
...
declare module 'cheetah-grid/header/style/CheckHeaderStyle' {
  import {CheckHeaderStyleOption, ColorDef} from "cheetah-grid/ts-types";
  import {Style} from "cheetah-grid/header/style/Style";
...
declare module 'cheetah-grid/header/style/MultilineTextHeaderStyle' {
  import {LineClamp, MultilineTextHeaderStyleOption} from "cheetah-grid/ts-types";
  import {Style} from "cheetah-grid/header/style/Style";
...
declare module 'cheetah-grid/header/style/SortHeaderStyle' {
  import {ColorDef, SortHeaderStyleOption} from "cheetah-grid/ts-types";
  import {Style} from "cheetah-grid/header/style/Style";
...
declare module 'cheetah-grid/header/style/Style' {
  import {ColorDef, HeaderStdStyleOption, TextOverflow} from "cheetah-grid/ts-types";
...
declare module 'cheetah-grid/header/type/BaseHeader' {
  import {CellContext, EventListenerId, GridCanvasHelperAPI, LayoutObjectId, ListGridAPI} from "cheetah-grid/ts-types";
  import {BaseStyle} from "cheetah-grid/header/style/BaseStyle";
  import {DrawCellInfo} from "cheetah-grid/ts-types-internal";
...
declare module 'cheetah-grid/list-grid/layout-map/internal/simple-header-layout' {
  import {CellRange, LayoutObjectId} from "cheetah-grid/ts-types";
  import {ColumnData, HeaderData, HeadersDefine, LayoutMapAPI} from "cheetah-grid/list-grid/layout-map/api";
...
declare module 'cheetah-grid/list-grid/layout-map/internal/multi-layout' {
  import {ColumnData, HeaderData, LayoutDefine, LayoutMapAPI, WidthData} from "cheetah-grid/list-grid/layout-map/api";
  import {CellRange, LayoutObjectId} from "cheetah-grid/ts-types";
...
declare module 'cheetah-grid/columns/message/BaseMessage' {
  import {CellContext, ColumnStyle, GridCanvasHelperAPI, ListGridAPI, MessageObject} from "cheetah-grid/ts-types";
  import {DrawCellInfo} from "cheetah-grid/ts-types-internal";
  import {MessageElement} from "cheetah-grid/columns/message/internal/MessageElement";
...
declare module 'cheetah-grid/element/Inline' {
  import {AnyFunction, ColorDef, InlineAPI, RectProps} from "cheetah-grid/ts-types";
  import {Canvashelper} from "cheetah-grid/tools/canvashelper";
...
declare module 'cheetah-grid/ts-types-internal/grid-engine' {
  import {CellAddress, FieldDef} from "cheetah-grid/ts-types/grid";
  import {CellContext, GridCanvasHelperAPI, ListGridAPI} from "cheetah-grid/ts-types/grid-engine";
  import {ColorPropertyDefine, ColumnIconOption} from "cheetah-grid/ts-types/define";
  import {ColumnStyle, ColumnStyleOption, HeaderStyleOption} from "cheetah-grid/ts-types/column";
  import {Message} from "cheetah-grid/ts-types/data";
...
declare module 'cheetah-grid/columns/action/BaseInputEditor' {
  import {CellAddress, EditorOption, EventListenerId, LayoutObjectId, ListGridAPI} from "cheetah-grid/ts-types";
  import {Editor} from "cheetah-grid/columns/action/Editor";
...
declare module 'cheetah-grid/columns/style/StdBaseStyle' {
  import {BaseStyle} from "cheetah-grid/columns/style/BaseStyle";
  import {StdBaseStyleOption} from "cheetah-grid/ts-types";
...
declare module 'cheetah-grid/columns/style/BranchGraphStyle' {
  import {BranchGraphStyleOption, ColorDef} from "cheetah-grid/ts-types";
  import {BaseStyle} from "cheetah-grid/columns/style/BaseStyle";
...
declare module 'cheetah-grid/columns/message/internal/MessageElement' {
  import {ListGridAPI, MessageObject} from "cheetah-grid/ts-types";
